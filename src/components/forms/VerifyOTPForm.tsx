...
//             <FormInput name='email' id='email' value={email}  placeholder='ENTER YOUR EMAIL' disabled type='email' className='min-w-full border hover:border-black rounded-sm px-4 py-3 text-sm' />
//             <ReactCodeInput type='number' fields={5} name="otp"
//                 inputMode="numeric" />
