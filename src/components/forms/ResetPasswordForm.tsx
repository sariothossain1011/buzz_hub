...
//                 password:password
//             }
//             const response = await instance.get(`RecoverVerifyEmail`,body);
...
//     return (
//         <Form submitHandler={handle} className=' min-w-full flex flex-col gap-4'>
//             <FormInput
//                 name="email"
//                 id="email"
//                 value={email || ""}
...
//             />
//             <FormInput name='password' id='password' placeholder='NEW PASSWORD' type='password' className='  min-w-full border hover:border-black rounded-sm px-4 py-3 text-sm' />
